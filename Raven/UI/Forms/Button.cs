...
public partial class UIButton : IUIForm {
    ...
    public void draw() {
        ...
        //background
        Draw2D.fill_rect(top_left - mo_offset, bottom_right - mo_offset, Draw2D.ColorInterpolate(color_background, color_foreground, mdlerp.Value));
        //text
        Draw2D.text(font_name, text, position - mo_offset + (size / 2) - (ms / 2), Draw2D.ColorInterpolate(color_foreground, color_background, mdlerp.Value));
        //border
